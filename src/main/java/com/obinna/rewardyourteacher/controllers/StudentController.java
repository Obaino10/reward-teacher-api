...
public class StudentController {
    ...
    public ResponseEntity<APIResponse<UserResponseDTO>> updateStudent(
            @PathVariable(value = "id")Long id, @RequestBody StudentRequestDTO userRequestDTO,
            Principal principal
    ) {
        String email = principal.getName();
        try {
            UserResponseDTO responseDTO = studentService.updateStudent(id, userRequestDTO, email);
