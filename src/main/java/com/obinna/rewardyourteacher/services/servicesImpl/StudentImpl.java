...
public class StudentImpl implements StudentService {
    ...
    @Override
    public UserResponseDTO updateStudent(Long id, StudentRequestDTO userRequestDTO, String email) {
        return userImpl.updateStudentResponseEntity(id, userRequestDTO, studentRepository, email);
    }
    ...
    private List<User> findTeachers(Integer pageNumber, Integer pageSize, String sortProperty, String school) {
        ...
        if (school != null && !"".equals(school.trim())) {
            builder.append("and lower(u.school.name) = lower(:school) ");
        }
