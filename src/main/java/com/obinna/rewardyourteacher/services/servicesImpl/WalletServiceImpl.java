...
public class WalletServiceImpl implements WalletService {
    ...
    public void fundWallet(String email, VerifyTransactionResponse payStackResponse, String walletName, String description) {
        ...
        Transaction savedTransaction = transactionService.saveTransaction(user, amount, description);
        ...
        Notification notification = notificationService.saveNotification(user, description, "Successful");
    ...
    public WalletResponse getWallet(String email) {
        ...
        Wallet wallet = user.getWallet();
        if (wallet == null) {
            throw new CustomException("Wallet does not exist");
        }
