...
public class SchoolController {
    ...
    public ResponseEntity<APIResponse<List<SchoolResponse>>> getAllSchools(@RequestParam(value = "pageNo", defaultValue = "1") int pageNumber,
                                                   @RequestParam(value = "pageSize", defaultValue = "10") int pageSize,
                                                   @RequestParam(value = "sortProperty", defaultValue = "name") String sortProperty) {
        try {
            List<SchoolResponse> responseList = schoolService.getAllSchools(pageNumber, pageSize, sortProperty);
