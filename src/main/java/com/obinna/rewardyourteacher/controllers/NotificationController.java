...
public class NotificationController {
    ...
    public ResponseEntity<APIResponse<List<Notification>>> getUserNotifications (final Principal principal) {
        final String email = principal.getName();
        try {
            final List<Notification> notifications = notificationService.getAllNotificationsOfUser(email);
