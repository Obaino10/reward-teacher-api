...
public class TeacherController {
    ...
    public ResponseEntity<APIResponse<UserResponseDTO>> updateTeacher(@PathVariable(value = "id")Long id, @RequestBody TeacherRequestDTO teacherRequestDTO,
                                           Principal principal
    ){
        String email = principal.getName();
        try {
            UserResponseDTO responseDTO = teacherService.updateTeacher(id, teacherRequestDTO, email);
